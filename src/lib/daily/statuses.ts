...
export const DAILY_STATUS_TYPES: DailyStatusType[] = [
  {
    slug: 'supercharged', code: 'MAX', name: '满血复活', tagline: '今天你就是主角。',
    color: '#22c55e', emoji: '⚡',
  ...
  {
    slug: 'zombie', code: 'ZZZ', name: '行尸走肉', tagline: '人在，魂不在。',
    color: '#78716c', emoji: '🧟',
  ...
  {
    slug: 'cave', code: 'CAVE', name: '洞穴模式', tagline: '别找我，我在充电。',
    color: '#6366f1', emoji: '🦇',
  ...
  {
    slug: 'chill', code: 'ZEN', name: '佛系今天', tagline: '差不多得了，别太卷。',
    color: '#14b8a6', emoji: '🧘',
  ...
  {
    slug: 'machine', code: 'AUTO', name: '效率机器', tagline: '别跟我说话，我在心流。',
    color: '#3b82f6', emoji: '🤖',
  ...
  {
    slug: 'lowbat', code: 'LOW', name: '低电量警告', tagline: '不是不想动，是真的动不了。',
    color: '#f97316', emoji: '🪫',
  ...
  {
    slug: 'vibe', code: 'VIBE', name: '在线发呆', tagline: '不想动脑，只想放空。',
    color: '#06b6d4', emoji: '🎵',
