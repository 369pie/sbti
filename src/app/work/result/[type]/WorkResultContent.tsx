        ...
        >
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl border border-indigo-500/20 bg-indigo-500/5 text-sm text-indigo-400 hover:bg-indigo-500/10 transition-all cursor-pointer"
            >
