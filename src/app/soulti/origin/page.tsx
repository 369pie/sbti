  ...
  return (
    <div className="min-h-screen" style={{ background: '#FAF8F5' }}>
      <header className="max-w-3xl mx-auto px-6 pt-16 pb-10 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl mb-4" style={{ fontFamily: serifFont, color: '#2D2A26' }}>
          她们以你的频率燃烧过
        </h1>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {origins.map(o => (
            <li key={o.slug}>
              ...
              >
                <p className="text-[10px] tracking-[0.25em] uppercase mb-2" style={{ fontFamily: monoFont, color: '#8b7355' }}>
                  {o.era}
                </p>
                <h2 className="text-xl mb-1" style={{ fontFamily: serifFont, color: '#2D2A26' }}>
                  {o.zhName}
                </h2>
                <p className="text-xs mb-3" style={{ fontFamily: monoFont, color: '#9a918a' }}>
                  {o.name}
                </p>
                <p className="text-xs leading-[1.9]" style={{ fontFamily: serifFont, color: '#6a6054' }}>
