...
const OUTPUT_DIR = path.join(process.cwd(), 'public/images/mysti/tarot/pale');
...
<svg xmlns="http://www.w3.org/2000/svg" width="540" height="810" viewBox="0 0 540 810">
  ...
  <!-- Decorative border -->
  <rect x="20" y="20" width="500" height="770" fill="none" stroke="#A85C64" stroke-width="2" rx="8" ry="8" opacity="0.45"/>
  <rect x="30" y="30" width="480" height="750" fill="none" stroke="#A85C64" stroke-width="1" rx="6" ry="6" opacity="0.25"/>

  <!-- Top ornament -->
  <circle cx="270" cy="110" r="40" fill="none" stroke="#A85C64" stroke-width="1.5" opacity="0.35"/>
  <text x="270" y="122" font-size="32" fill="#A85C64" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-weight="400" opacity="0.85">${safeRoman}</text>

  <!-- Divider lines -->
  <line x1="170" y1="170" x2="370" y2="170" stroke="#A85C64" stroke-width="1" opacity="0.35"/>
  <line x1="170" y1="640" x2="370" y2="640" stroke="#A85C64" stroke-width="1" opacity="0.35"/>

  <!-- English title -->
  <text x="270" y="360" font-size="42" fill="#A85C64" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" font-weight="500" letter-spacing="1">${safeName}</text>

  <!-- Chinese keyword -->
  <text x="270" y="420" font-size="24" fill="#A85C64" text-anchor="middle" font-family="'Arial Unicode MS', 'STHeiti', 'Hiragino Sans GB', sans-serif" font-weight="300" opacity="0.85">${safeKeyword}</text>

  <!-- Bottom text -->
  <text x="270" y="720" font-size="14" fill="#A85C64" text-anchor="middle" font-family="Georgia, 'Times New Roman', serif" opacity="0.45" letter-spacing="2">MYSTI TAROT</text>
</svg>`;
}
...
async function main() {
  ...
  console.log('Generating pale Major Arcana placeholder cards...');
  ...
  console.log('\nDone! All pale placeholder images are ready in public/images/mysti/tarot/pale/');
}
