...
> Review Cadence: Before API surface changes
> Next Decision: Decide whether the bootstrap and pairing endpoints are stable enough to treat this draft as implementation-ready
