...
> Review Cadence: Before each Mysti UI implementation pass
> Next Decision: Decide whether Mysti v1 keeps dual-theme support or narrows to one primary visual theme
> 版本：v1.0  
...
- [ ] 创建 `docs/02-modules/mysti/mysti-card-ui-spec.md`（本文档）
