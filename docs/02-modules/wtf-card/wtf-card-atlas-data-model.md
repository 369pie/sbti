...
> Review Cadence: Weekly until atlas model is locked
> Next Decision: Decide whether the shelf model ships before or after relationship cloud sync
...
> - `docs/02-modules/cpti/cpti-supabase-schema-v1.sql`
