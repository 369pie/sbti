...
> Review Cadence: On brand-facing updates
> Next Decision: Decide whether the WTFTI migration can be declared complete and residual SBTI references archived
...
- 以下文档中的旧域名已替换为 `wtfti.com`：
  - `docs/01-strategy/wtfti-product-roadmap.md`
  - `docs/04-design-growth/growth/xiaohongshu-universe-posts.md`
  - `docs/04-design-growth/design/share-card-redesign-proposal.md`
  - `docs/04-design-growth/growth/herti-competitive-strategy.md`
