...
This layer stores documents that support release discipline and platform operations.

- [docs-metadata-governance.md](docs-metadata-governance.md) — metadata vocabulary, header contract, and lint rules for repo docs
